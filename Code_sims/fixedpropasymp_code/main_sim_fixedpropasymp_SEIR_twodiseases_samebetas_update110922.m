...
% same reproduction numbers, beta_a = beta_s
...
if which_timescales==1
    ...
    beta_a_init = 0.4835; % beta_s = beta_a;
    ...
    if with_mitigation==0
        filename = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and5.mat';
    else
        filename = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and5_mit.mat';
    end
...
elseif which_timescales==2
    ...
    % set betas s.t. beta_s = beta_a are the same and r=0.14
    beta_a_init = 0.4154; % beta_s = beta_a; %0.4970;
    ...
    if with_mitigation==0
        filename = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and6.mat';
    else
        filename = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and6_mit.mat';
    end
    ...
    if with_mitigation==0
        filename = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and8.mat';
    else
        filename = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and8_mit.mat';
    end
