...
if with_mitigation==1
    ...
    if which_timescales==1
        ...
        init_mitigation_level=0.1225;
        
        fprintf('finding minimum wrt transmission rates... \n\n');
        
        [x_soln,f_val] = fminsearch(@(x)mitigation_objective_function(x,params),init_mitigation_level);
        mitigation_level = x_soln;
        
    elseif which_timescales==2
        
        init_mitigation_level=0.115;
        %         Rt_final = ;
        
    else
        
        init_mitigation_level=0.0955;
        %         Rt_final = ;
