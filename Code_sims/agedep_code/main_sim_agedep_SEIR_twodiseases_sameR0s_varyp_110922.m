...
susc_allages = 1; % fixed susceptibility all ages
...
% probability_symptomatic_byage= proportion_symptomatic_incidence*ones(size(data_Shanghai_Davies.prob_symp));
...
if which_timescales==1
    ...
    t_end_burnin = 163.97; % burn-in time
    
    
    % file names of simulations if saved
    if with_mitigation==0
        
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_110922_T5and5.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_110922_T5and5_mit.mat';
...
% set betas s.t. R0,a=R0,s are the same and r=0.14
    ...
    % burnin time depends on parameters
    t_end_burnin = 164.47; % burn-in time
    
    
    if with_mitigation==0
        
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_110922_T5and8.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_110922_T5and8_mit.mat';
        
        fprintf('With Mitigation ... \n\n');
        this_title = 'With Mitigation';
        
        %         mitigation_level=0.0983;
        mitigation_level=0.0953;
    ...
    t_end_burnin = 161.78; % burn-in time
    susc_allages = 1;
    
    
    if with_mitigation==0
        
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_T2and8.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_T2and8_mit.mat';
