...
if which_timescales==1
    ...
    [x_soln,f_val] = fminsearch(@(x)growthrate_objective_function_samebetas(x,params),x0);
    
    beta_a = x_soln(1);
    beta_s = beta_a; % same R0s
    ...
    if with_mitigation==0
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_samebetas_110922_T5and5.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_samebetas_110922_T5and5_mit.mat';
...
elseif which_timescales==2
    ...
    % burnin time depends on parameters
    t_end_burnin = 165.92; % burn-in time
    
    
    if with_mitigation==0
        
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_samebetas_110922_T5and8.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_samebetas_110922_T5and8_mit.mat';
