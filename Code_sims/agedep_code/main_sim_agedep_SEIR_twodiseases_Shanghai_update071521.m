...
if which_timescales==1
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_071321_Shanghai_T5and5.mat';
        else
            filename = 'SEIR_agedep_twodiseases_071321_Shanghai_T5and5_ia.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_071321_Shanghai_T5and5_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_071321_Shanghai_T5and5_mit_ia.mat';
        end
    end
...
elseif which_timescales==2
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_071321_Shanghai_T5and8.mat';
        else
            filename = 'SEIR_agedep_twodiseases_071321_Shanghai_T5and8_ia.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_071321_Shanghai_T5and8_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_071321_Shanghai_T5and8_mit_ia.mat';
        end
    end
