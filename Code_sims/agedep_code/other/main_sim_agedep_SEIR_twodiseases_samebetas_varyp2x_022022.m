...
if which_timescales==1
    ...
    t_end_burnin = 170.44; % burn-in time
    susc_allages = 1;
    ...
    if with_mitigation==0
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_T5and52x.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_T5and52x_mit.mat';
...
elseif which_timescales==2
    ...
    this_beta = 0.0268;
    beta_a = this_beta; beta_s = this_beta;
    t_end_burnin = 173; % burn-in time
    susc_allages = 1;
    
    
    if with_mitigation==0
        
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_T5and82x.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_T5and82x_mit.mat';
        
        fprintf('With Mitigation ... \n\n');
        this_title = 'With Mitigation';
        
        mitigation_level=0.131;
