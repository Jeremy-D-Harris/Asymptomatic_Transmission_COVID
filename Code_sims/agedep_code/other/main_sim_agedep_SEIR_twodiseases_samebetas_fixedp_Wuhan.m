...
proportion_symptomatic_incidence = 0.4043;
...
if which_timescales==1
    ...
    t_end_burnin = 156.24; % burn-in time
    susc_allages = 1;
    ...
    if with_mitigation==0
        ...
        filename = 'SEIR_agedep_twodiseases_novariationsymptomaticity_Wuhan_T5and5.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_novariationsymptomaticity_Wuhan_T5and5_mit.mat';
        
        fprintf('With Mitigation ... \n\n');
        this_title = 'With Mitigation';

        mitigation_level=0.1293;
...
elseif which_timescales==2
    ...
    if with_mitigation==0
        ...
        filename = 'SEIR_agedep_twodiseases_novariationsymptomaticity_Wuhan_T5and8.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_novariationsymptomaticity_Wuhan_T5and8_mit.mat';
        
        fprintf('With Mitigation ... \n\n');
        this_title = 'With Mitigation';
        
        mitigation_level=0.0838;
