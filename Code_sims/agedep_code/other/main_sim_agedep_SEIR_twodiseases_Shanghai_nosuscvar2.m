...
%         beta_a = 0.005; beta_s = 0.12;
        ...
        t_end_burnin = 158.91; % burn-in time
%         susc_allages = 0.76;
        susc_allages = 1;
...
%         beta_a = 0.018; beta_s = 0.06;
        ...
        t_end_burnin = 161.51; % burn-in time
        susc_allages = 1;
    end
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            ...
            filename = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5_mit_ia2.mat';
        end
    end
...
elseif which_timescales==2
    ...
    if increased_assortativity_yesno==0
        ...
        t_end_burnin = 158.64; % burn-in time
        susc_allages = 1;
        ...
        t_end_burnin =159.44; % burn-in time
        susc_allages = 1;
    end
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            ...
            filename = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8_mit_ia2.mat';
        end
    end
...
if with_mitigation==1
    ...
    if increased_assortativity_yesno==1
        ...
        if which_timescales==1
            mitigation_level=0.1515;
        else
            mitigation_level=0.13;
        end
