...
%         beta_a = 0.0183; beta_s = 0.0457;
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsv_Shanghai_T5and5.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsv_Shanghai_T5and5_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsv_Shanghai_T5and5_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsv_Shanghai_T5and5_mit_ia2.mat';
        end
    end
...
%         beta_a = 0.0115; beta_s = 0.0494;
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsv_Shanghai_T5and8.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsv_Shanghai_T5and8_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsv_Shanghai_T5and8_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsv_Shanghai_T5and8_mit_ia2.mat';
        end
    end
