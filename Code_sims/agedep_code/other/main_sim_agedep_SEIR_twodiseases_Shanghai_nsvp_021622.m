...
%         beta_a = 0.00864; beta_s = 0.0864;
        this_beta = 0.0445;
        beta_a = this_beta; beta_s = this_beta;
        t_end_burnin = 163.81; % burn-in time
%         susc_allages = 0.76;
        susc_allages = 1;
        
    else
        % 2 times assortativity
%         beta_a = 0.018; beta_s = 0.06;
%         beta_a = 0.0147; beta_s = 0.0492;
        this_beta = 0.0248;
        beta_a = this_beta; beta_s = this_beta;
        t_end_burnin = 172.91; % burn-in time
        susc_allages = 1;
    end
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and5.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and5_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and5_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and5_mit_ia2.mat';
        end
    end
...
%         beta_a = 0.0346; beta_s = 0.0446;
        this_beta = 0.0375;
        beta_a = this_beta; beta_s = this_beta;
        t_end_burnin = 165.85; % burn-in time
        susc_allages = 1;

    else
        % 2 times assortativity
%         beta_a = 0.0115; beta_s = 0.0494;
%         beta_a = 0.0143; beta_s = 0.0455;
        this_beta = 0.021;
        beta_a = this_beta; beta_s = this_beta;
        t_end_burnin =174.58; % burn-in time
        susc_allages = 1;
    end
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and8.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and8_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and8_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and8_mit_ia2.mat';
        end
    end
...
if with_mitigation==1
    ...
    if increased_assortativity_yesno==1
        fprintf('With mitigation, 2x assortativity... \n\n');
        this_title = 'With mitigation, 2x';
        
        if which_timescales==1
            mitigation_level=0.295;
        else
            mitigation_level=0.195;
        end
    ...
    if increased_assortativity_yesno==1
        fprintf('No mitigation, 2x assortativity... \n\n');
        this_title = 'No mitigation, 2x';
    else
...
probability_symptomatic_byage= 0.3521*ones(size(data_Shanghai_Davies.prob_symp));
% probability_symptomatic_byage= 0.2623*ones(size(data_Shanghai_Davies.prob_symp));
% probability_symptomatic_byage= 0.6*ones(size(data_Shanghai_Davies.prob_symp));
