...
if which_timescales==1
    ...
    if increased_assortativity_yesno==0
        ...
        t_end_burnin = 214.83; % burn-in time
        %         susc_allages = 0.76;
        susc_allages = 1;
        ...
        %         this_beta = 0.0248;
        %         beta_a = this_beta; beta_s = this_beta;
        gamma_a=1/5; gamma_s=1/6;
        beta_a = 0.0346; beta_s = 0.0446;
        t_end_burnin = 197.64; % burn-in time
        susc_allages = 1;
    end
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and5.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and6.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and5_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and6_mit.mat';
        end
    end
...
elseif which_timescales==2
    ...
    if increased_assortativity_yesno==0
        ...
        %         beta_a = this_beta; beta_s = this_beta;
        beta_a = 0.0346; beta_s = 0.0446;
        t_end_burnin = 165.13; % burn-in time
        susc_allages = 1;
        
    else
        
        fprintf('Don not use this one! \n\n');
        % 2 times assortativity
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and8.mat';
        else
            filename = 'nonsense.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and8_mit.mat';
        else
            filename = 'nonsense_mit.mat';
        end
    end
