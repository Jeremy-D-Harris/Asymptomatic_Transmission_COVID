...
load('agedep_data_Wuhan_update071321.mat');
...
if which_timescales==1
    ...
    t_end_burnin = 159.21; % burn-in time
    susc_allages = 1;
    ...
    if with_mitigation==0
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_Wuhan_T5and5.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_Wuhan_T5and5_mit.mat';
        
        fprintf('With Mitigation ... \n\n');
        this_title = 'With Mitigation';

        mitigation_level=0.137;
...
elseif which_timescales==2
    ...
    this_beta = 0.0378;
    beta_a = this_beta; beta_s = this_beta;
    t_end_burnin = 161.30; % burn-in time
    susc_allages = 1;
    
    
    if with_mitigation==0
        
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_Wuhan_T5and8.mat';
        ...
        filename = 'SEIR_agedep_twodiseases_variationsymptomaticity_Wuhan_T5and8_mit.mat';
        
        fprintf('With Mitigation ... \n\n');
        this_title = 'With Mitigation';
        
        mitigation_level=0.0894;
%         mitigation_level=0.04;
...
Shanghai_contact_matrix = data_Wuhan_Davies.contact_matrix;
...
susceptibility_byage= susc_allages*ones(size(data_Wuhan_Davies.susc_infection));

% symptomatic probabiility by age
probability_symptomatic_byage= data_Wuhan_Davies.prob_symp;
% probability_symptomatic_byage= proportion_symptomatic_incidence*ones(size(data_Wuhan_Davies.prob_symp));
% probability_symptomatic_byage= 0.6*ones(size(data_Wuhan_Davies.prob_symp));
...
axis([0 params.t_span(end) 30 50]);
...
if save_ans==1
    ...
    save(strcat(folder_location,filename),'params','results','data_Wuhan_Davies');
