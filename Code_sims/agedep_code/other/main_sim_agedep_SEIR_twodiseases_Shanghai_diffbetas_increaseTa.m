...
if which_timescales==1
    ...
    if increased_assortativity_yesno==0
        ...
        beta_a = 0.0346; beta_s = 0.0446;
        t_end_burnin = 191.1; % burn-in time
        susc_allages = 1;
    end
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            ...
            filename = 'SEIR_agedep_twodiseases_dbit_Shanghai_T5and6.mat';
        ...
        if increased_assortativity_yesno==0
            ...
            filename = 'SEIR_agedep_twodiseases_dbit_Shanghai_T5and6_mit.mat';
        end
    end
