...
%         beta_a = 0.0147; beta_s = 0.0492;
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_sbfp_Shanghai_T5and5.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and5.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_sbfp_Shanghai_T5and5_mit.mat';
        else
...
%         beta_a = 0.0346; beta_s = 0.0446;
        this_beta = 0.0375;
        beta_a = this_beta; beta_s = this_beta;
        t_end_burnin = 164.63; % burn-in time
        susc_allages = 1;
...
%         beta_a = 0.0143; beta_s = 0.0455;
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_sbfp_Shanghai_T5and8.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and8_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_sbfp_Shanghai_T5and8_mit.mat';
        else
