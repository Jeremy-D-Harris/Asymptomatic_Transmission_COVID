...
%         beta_a = 0.022; beta_s = 0.1;
        ...
        t_end_burnin = 158.09; % burn-in time
    else
        % 2 times assortativity
        beta_a = 0.0481; beta_s = 0.04;
%         beta_a = 0.03; beta_s = 0.026;
        t_end_burnin = 158.57; % burn-in time
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_sv_Shanghai_T5and5.mat';
        else
            filename = 'SEIR_agedep_twodiseases_sv_Shanghai_T5and5_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_sv_Shanghai_T5and5_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_sv_Shanghai_T5and5_mit_ia2.mat';
        end
    end
...
%         beta_a = 0.018; beta_s = 0.099;
        beta_a = 0.0473; beta_s = 0.056;
        t_end_burnin = 158.53; % burn-in time
    else
        % 2 times assortativity
%         beta_a = 0.0235; beta_s = 0.026;
        beta_a = 0.038; beta_s = 0.0392;
        %         beta_a = 0.05; beta_s = 0.078;
        t_end_burnin =157.80; % burn-in time
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_sv_Shanghai_T5and8.mat';
        else
            filename = 'SEIR_agedep_twodiseases_sv_Shanghai_T5and8_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_sv_Shanghai_T5and8_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_sv_Shanghai_T5and8_mit_ia2.mat';
        end
    end
...
if with_mitigation==1
    ...
    if increased_assortativity_yesno==1
        ...
        if which_timescales==1
            mitigation_level=0.17;
        else
            mitigation_level=0.14;
        end
