...
%         beta_a = 0.0147; beta_s = 0.0492;
        this_beta = 0.0248;
%         beta_a = 0.0183; beta_s = 0.0457;
        beta_a = this_beta; beta_s = this_beta;
        t_end_burnin = 172.99; % burn-in time
        susc_allages = 1;
    end
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsv2_Shanghai_T5and5.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsv2_Shanghai_T5and5_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsv2_Shanghai_T5and5_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsv2_Shanghai_T5and5_mit_ia2.mat';
        end
    end
...
%         this_beta = 0.0374;
%         beta_a = this_beta; beta_s = this_beta;
        t_end_burnin = 166.52; % burn-in time
        susc_allages = 1;

    else
        % 2 times assortativity
%         beta_a = 0.0115; beta_s = 0.0494;
        beta_a = 0.0197; beta_s = 0.023;
        t_end_burnin =174.53; % burn-in time
        susc_allages = 1;
    end
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsv2_Shanghai_T5and8.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsv2_Shanghai_T5and8_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_nsv2_Shanghai_T5and8_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_nsv2_Shanghai_T5and8_mit_ia2.mat';
        end
    end
...
if with_mitigation==1
    ...
    if increased_assortativity_yesno==1
        ...
        if which_timescales==1
            mitigation_level=0.296;
        else
            mitigation_level=0.222;
        end
...
axis([0 params.t_span(end) 20 45]);
