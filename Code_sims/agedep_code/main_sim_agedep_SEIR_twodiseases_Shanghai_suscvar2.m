...
%         beta_a = 0.0110; beta_s = 0.11;
        beta_a = 0.022; beta_s = 0.1;
        t_end_burnin = 158.92; % burn-in time
    else
        % 2 times assortativity
        beta_a = 0.0365; beta_s = 0.052;
%         beta_a = 0.03; beta_s = 0.026;
        t_end_burnin = 158.73; % burn-in time
    ...
    if with_mitigation==0
        ...
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_020822_Shanghai_T5and5.mat';
        else
            filename = 'SEIR_agedep_twodiseases_020822_Shanghai_T5and5_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_020822_Shanghai_T5and5_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_020822_Shanghai_T5and5_mit_ia2.mat';
        end
    end
...
elseif which_timescales==2
    ...
    if increased_assortativity_yesno==0
        beta_a = 0.018; beta_s = 0.099;
        t_end_burnin = 157.84; % burn-in time
    else
        % 2 times assortativity
%         beta_a = 0.0235; beta_s = 0.026;
        beta_a = 0.0285; beta_s = 0.052;
        %         beta_a = 0.05; beta_s = 0.078;
        t_end_burnin =157.69; % burn-in time
    ...
    if with_mitigation==0
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_020822_Shanghai_T5and8.mat';
        else
            filename = 'SEIR_agedep_twodiseases_020822_Shanghai_T5and8_ia2.mat';
        end
    else
        if increased_assortativity_yesno==0
            filename = 'SEIR_agedep_twodiseases_020822_Shanghai_T5and8_mit.mat';
        else
            filename = 'SEIR_agedep_twodiseases_020822_Shanghai_T5and8_mit_ia2.mat';
        end
    end
...
if with_mitigation==1
    ...
    if increased_assortativity_yesno==1
        ...
        if which_timescales==1
            mitigation_level=0.1655;
        else
            mitigation_level=0.1475;
        end
        ...
        if which_timescales==1
            mitigation_level=0.1355;
        else
            mitigation_level=0.1255;
        end
...
axis([0 params.t_span(end) 10 45]);
