...
if relR0 == 1
% first thing - load intrinsic proportion incidence values
infile = 'SEIR_assortmixing_twodiseases_sameR0s_varyTa_113022_refine.mat';
load(strcat('../../Code_plt_ms_figures/sim_data/',infile));
...
for kk = 1:length(params_collect(1).k_vector_relT)
    proportion_asymp_incidence_intrinsic_vary(kk) = params_collect(kk).p;
end

k_vector_relT = params_collect(1).k_vector_relT;

%%
clear('infile','params_collect','results_collect','kk');
...
% filename = 'SEIR_assortmixing_twodiseases_sameR0s_varyTa_113022.mat';
% filename = 'SEIR_assortmixing_twodiseases_sameR0s_varyTa_113022_refine.mat';
filename = 'SEIR_assortmixing_twodiseases_sameR0s_varyTa_113022_baseline.mat';
...
%% relative reproduction numbers - Ra/Rs
relR0 = 1;
params.relR0 = relR0;
...
for count=1:length(k_vector_relT)
    ...
    % set to intrinsic that matches r
    proportion_asymp = proportion_asymp_incidence_intrinsic_vary(count);
    p_aa = proportion_asymp; p_as = p_aa;
    params.p_aa = p_aa; params.p_as = p_as;
