...
if which_timescales==1
    ...
    beta_a = 0.482838964843750; beta_s = beta_a;
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_samebetas_120122_T5and5.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_samebetas_120122_T5and5_mit.mat';
    end
...
elseif which_timescales==2
    ...
    [x_soln,f_val] = fminsearch(@(x)growthrate_objective_function_p_as(x,params),x0,options);
...
%     params.p_aa = p_aa;
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_samebetas_120122_T5and8.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_samebetas_120122_T5and8_mit.mat';
    end
