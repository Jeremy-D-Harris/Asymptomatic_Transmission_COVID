...
if which_timescales==1
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_sameR0s_011722_T5and5.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_sameR0s_011722_T5and5_mit.mat';
    end
...
elseif which_timescales==2
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_sameR0s_011722_T5and8.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_sameR0s_011722_T5and8_mit.mat';
    end
