...
filename = 'SEIR_assortmixing_twodiseases_varyTa_113022.mat';
...
k_vector_relT_Tavary = linspace(1,8/5,3); % ratio of Ta/Ts - Ts fixed
k_vector_relT_Tsvary = linspace(5/8,1,3); % ratio of Ta/Ts - Tas fixed
