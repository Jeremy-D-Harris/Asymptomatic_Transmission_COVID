...
if which_timescales==1
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_samebetas_110922_T5and5.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_samebetas_110922_T5and5_mit.mat';
    end
...
elseif which_timescales==2
    ...
    p_aa = 0.70; % contour data from S9
    p_as = 0.1428; 
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_samebetas_110922_T5and8.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_samebetas_110922_T5and8_mit.mat';
    end
