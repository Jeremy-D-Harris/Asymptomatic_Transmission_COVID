...
%     beta_a = 0.482838964843750; % beta_s = beta_a;
    ...
    % set betas s.t. R0,a=R0,s are the same and r=0.14
    beta_a_init = 0.4835; % beta_s_init = beta_a_init;
...
%         params.beta_s = beta_s_init;
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_samebetas_120122_fix_T5and5.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_samebetas_120122_fix_T5and5_mit.mat';
    end
...
elseif which_timescales==2
    ...
    % set betas s.t. R0,a=R0,s are the same and r=0.14
    beta_a_init = 0.4835; % beta_s = beta_a_init;
...
%         params.beta_s = beta_s_init;
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_samebetas_120122_fix_T5and8.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_samebetas_120122_fix_T5and8_mit.mat';
    end
