...
if which_timescales==1
    ...
    % along the line p_aa = 1-(3/2)*p_as <--> p_as = 2/3*(1-p_aa)
    p_aa = 0.5;
    p_as = 1/3;
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_sameR0s_120122_T5and5.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_sameR0s_120122_T5and5_mit.mat';
    end
...
%     params.p_aa = p_aa;
    ...
    if with_mitigation==0
        filename = 'SEIR_assortmixing_twodiseases_sameR0s_120122_T5and8.mat';
    else
        filename = 'SEIR_assortmixing_twodiseases_sameR0s_120122_T5and8_mit.mat';
    end
