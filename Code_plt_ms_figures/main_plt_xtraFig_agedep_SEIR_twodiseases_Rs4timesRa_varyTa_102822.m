...
figure_name = 'Figure3_agedep_assortativity_symptomaticity_varyTa_031022';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_Rs4timesRa_T5and8.mat';
            load(strcat('./sim_data/',infile));
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_Rs4timesRa_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
