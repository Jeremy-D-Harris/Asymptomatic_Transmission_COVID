...
figure_name = 'Figure2_correlations_sameR0s_min_120122';
...
for counter=1:length(switch_over_var)
    ...
    switch this_file
        ...
        case 2
            ...
            % load: Ta=5 (same),
            infile = 'SEIR_assortmixing_twodiseases_sameR0s_120122_min_T5and5.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 3
            % WITH assortative mixing
            % load: Ta=8 (Ta=5)
            infile = 'SEIR_assortmixing_twodiseases_sameR0s_120122_min_T5and8.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
...
for counter=1:length(switch_over_var)
    ...
    switch this_file
        ...
        case 2
            % WITH assortative mixing
            % load: Ta=5 (same),
            infile = 'SEIR_assortmixing_twodiseases_sameR0s_120122_min_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_s2 = params.gamma_s;
            gamma_a2 = params.gamma_a;
        ...
        case 3
            % WITH assortative mixing
            % load: Ta=8 (Ta=5)
            infile = 'SEIR_assortmixing_twodiseases_sameR0s_120122_min_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_s3 = params.gamma_s;
            gamma_a3 = params.gamma_a;
