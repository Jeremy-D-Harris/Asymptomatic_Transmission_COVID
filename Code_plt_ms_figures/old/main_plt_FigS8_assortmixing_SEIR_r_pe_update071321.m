...
%% Figure S8 - paramtrize model wrt p(a|a) and p(a|s) to find:
...
figure_name='FigS8_parametrise_assortmixing_071321';
...
for which_timescales=1:2
    ...
    if which_timescales==1
        filename = 'parametrise_assortmixing_same_sameR0s_SEIR_071321';
    else
        filename = 'parametrise_assortmixing_diff_sameR0s_SEIR_071321';
    end
