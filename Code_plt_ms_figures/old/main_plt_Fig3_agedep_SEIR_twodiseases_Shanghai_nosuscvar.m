...
figure_name = 'Figure3_agedep_Shanghai_nosuscvar_axes20to50';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            ...
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5.mat';
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5_ia.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
        ...
        case 3
            ...
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 4
            ...
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8_ia.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            % Ta = Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a1 = params.gamma_a;
            gamma_s1 = params.gamma_s;
        ...
        case 2
            % Ta = Ts = 5 (4x assortivity)
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5_mit_ia.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
        ...
        case 3
            % Ta = 8, Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a3 = params.gamma_a;
            gamma_s3 = params.gamma_s;
        ...
        case 4
            ...
            % Ta = 8, Ts = 5 (4x assortivity)
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8_mit_ia.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a4 = params.gamma_a;
            gamma_s4 = params.gamma_s;
    ...
    if counter==4
        ...
        legend_char2 = ['$T_a = ', num2str(1/gamma_a2),'$, 4$\times$Assortativity'];
        legend_char3 = ['$T_a = ', num2str(1/gamma_a3),'$'];
        legend_char4 = ['$T_a = ', num2str(1/gamma_a4),'$, 4$\times$Assortativity'];
