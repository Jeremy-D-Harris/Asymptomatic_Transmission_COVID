...
figure_name = 'Figure_agedep_Shanghai_compare_nosympvar_021622_ia2';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            ...
            infile = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and5_ia2.mat';
            ...
            params.increased_assortativity_yesno=0; % to get solid line
        ...
        case 3
            ...
            infile = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and8_ia2.mat';
            load(strcat('./sim_data/',infile));
    ...
    if counter==4
        ...
        set(f1,'xticklabel',{[]},'yticklabel',[{''},{'25'},{'30'},{'35'},{'40'},{''}]);
        box('off');
        ...
        txt = {'45'};
        text(-0.07,0.95,txt,'Units','normalized',...
            'FontSize',14,'FontWeight','normal','FontName', 'Times');
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            % Ta = Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and5_mit_ia2.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a1 = params.gamma_a;
            gamma_s1 = params.gamma_s;
        ...
        case 3
            % Ta = 8, Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_nsvp_Shanghai_T5and8_mit_ia2.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a3 = params.gamma_a;
            gamma_s3 = params.gamma_s;
