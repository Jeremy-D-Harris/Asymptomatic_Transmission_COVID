...
figure_name = 'Figure_agedep_Shanghai_compare_increasingTa_021722';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and6.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 2
            % Ta = Ts = 5 (4x assortivity)
            infile = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and6_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
