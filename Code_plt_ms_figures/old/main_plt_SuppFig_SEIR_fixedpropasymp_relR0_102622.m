...
figure_name = 'FigureS3_fixedpropasymp_samebetas_031022';
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_Rs2timesRa_102622_T5and5.mat';
            load(strcat('./sim_data/',infile));
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 5
            % load: Ta=5 (same)
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_011722_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_Rs2timesRa_102622_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [169,90,161]/255; % violet
            gamma_s2 = params.gamma_s;
            gamma_a2 = params.gamma_a;
...
%     xlabel('Time (days)');
    ...
    if counter==3
        ...
        legend_char1 = ['$\mathcal R_{0,s} = \mathcal R_{0,a} $'];
        legend_char2 = ['$\mathcal R_{0,s} = 2\,\mathcal R_{0,a} $'];
        legend_char3 = ['$\mathcal R_{0,s} = 4\,\mathcal R_{0,a} $'];
