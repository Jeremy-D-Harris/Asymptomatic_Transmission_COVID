...
figure_name = 'SuppFig_fixedpropasymp_diffqz_vs_ratioR0_2panels_102622';
...
xlabel('$\mathcal R_{0,s}/\mathcal R_{0,a}$','Interpreter','Latex');
% xlabel('$\beta_{s}/\beta_{a}$','Interpreter','Latex');
ylabel({'Change in Proportion of'; 'Asymptomatic Transmission, $q(\infty) - q(0)$'},'Interpreter','Latex');
f1=gca;
f1.LineWidth = 1;
f1.FontSize = 14;
f1.FontWeight = 'normal';
