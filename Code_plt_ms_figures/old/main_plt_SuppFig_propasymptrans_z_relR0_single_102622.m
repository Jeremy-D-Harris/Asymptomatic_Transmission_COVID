...
figure_name = 'SuppFig_fixedpropasymp_zvsrelR0_102622';
...
% for counter=1:length(t_vary)
    ...
    this_t = t_vary(1);
    this_p(1)=plot(k_vector*this_t,z(1,:),'Color',cbf_colors_vector(1,:),'LineWidth',2); hold on;
    plot(k_discrete*this_t,z_discrete(1,:),'.','Color',cbf_colors_vector(1,:),'MarkerSize',20); hold on;
