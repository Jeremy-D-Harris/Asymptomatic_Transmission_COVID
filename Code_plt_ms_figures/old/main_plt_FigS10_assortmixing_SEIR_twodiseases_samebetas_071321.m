...
%% Figure 2 - parametrised with beta_a = beta_s
...
figure_name = 'FigS10_assortmixing_samebetas_071321';
...
for counter=1:length(switch_over_var)
    ...
    switch this_file
        ...
        case 1
            ...
            % load: Ta=8 (Ts=5)
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_071321_T5and8.mat';
        ...
        case 2
            ...
            % load: Ta=5 (same),
            infile = 'SEIR_assortmixing_twodiseases_samebetas_071321_T5and5.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 3
            % WITH assortative mixing
            % load: Ta=8 (Ta=5)
            infile = 'SEIR_assortmixing_twodiseases_samebetas_071321_T5and8.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
    ...
    subplot(4,2,1);
    if counter==1
        this_p = semilogy(params.t_span, results.I_tot,'Color',cbf_colors,'LineWidth',1); hold on;
...
for counter=1:length(switch_over_var)
    ...
    switch this_file
        ...
        case 1
            % NO assortative mixing
            % load: Ta=8 (Ts=5)
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_071321_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a1 = params.gamma_a;
        ...
        case 2
            % WITH assortative mixing
            % load: Ta=5 (same),
            infile = 'SEIR_assortmixing_twodiseases_samebetas_071321_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a2 = params.gamma_a;
        ...
        case 3
            % WITH assortative mixing
            % load: Ta=8 (Ta=5)
            infile = 'SEIR_assortmixing_twodiseases_samebetas_071321_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a3 = params.gamma_a;
    ...
    subplot(4,2,2);
    if counter==1
        h_leg(counter) = semilogy(params.t_span, results.I_tot,'Color',cbf_colors,'LineWidth',1); hold on;
        
    else
        h_leg(counter) = semilogy(params.t_span, results.I_tot,'--','Color',cbf_colors,'LineWidth',2); hold on;
