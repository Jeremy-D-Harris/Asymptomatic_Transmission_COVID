...
figure_name = 'SuppFig_fixedpropasymp_diffqz_vs_ratioR0_2panels_110122';
...
%% Ta=6
infile = 'SEIR_fixedpropasymp_twodiseases_Ta6_varyrelR0_103122.mat';
...
%% Ta=8
infile = 'SEIR_fixedpropasymp_twodiseases_Ta8_varyrelR0_103122.mat';
load(strcat('./sim_data/',infile));

%%
% k_vector_relR0 = params.k_vector_relR0;
for count=1:length(k_vector_relR0)
