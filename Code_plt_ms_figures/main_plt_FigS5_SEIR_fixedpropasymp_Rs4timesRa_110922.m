...
figure_name = 'FigureS5_fixedpropasymp_Rs4timesRa_varyTa_110922';
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 5
            % load: Ta=5 (same)
            infile = 'SEIR_fixedpropasymp_twodiseases_Rs4timesRa_110922_T5and5.mat';
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_Rs4timesRa_110922_T5and6.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 8
            % load: Ta=8
            infile = 'SEIR_fixedpropasymp_twodiseases_Rs4timesRa_110922_T5and8.mat';
            load(strcat('./sim_data/',infile));
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 5
            % load: Ta=5 (same)
            infile = 'SEIR_fixedpropasymp_twodiseases_Rs4timesRa_110922_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_Rs4timesRa_110922_T5and6_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [169,90,161]/255; % violet
            gamma_s2 = params.gamma_s;
            gamma_a2 = params.gamma_a;
        ...
        case 8
            % load: Ta=8
            infile = 'SEIR_fixedpropasymp_twodiseases_Rs4timesRa_110922_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_s3 = params.gamma_s;
            gamma_a3 = params.gamma_a;
