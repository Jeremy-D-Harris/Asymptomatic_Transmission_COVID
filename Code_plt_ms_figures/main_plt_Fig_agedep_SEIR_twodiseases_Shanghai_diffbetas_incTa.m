...
figure_name = 'Figure_agedep_Shanghai_diffbetas_increasingTa';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            ...
            infile = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and5.mat';
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_dbit_Shanghai_T5and6.mat';
            load(strcat('./sim_data/',infile));
            ...
            params.increased_assortativity_yesno=0; % to get dashed line
            
        case 3
            % Ta = 8, Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and8.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 4
            ...
            infile = 'SEIR_agedep_twodiseases_dbvp_Shanghai_T5and8.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            ...
            params.increased_assortativity_yesno=1; % to get dashed line
    ...
    if counter==4
        ...
        txt = {'0.7'};
        text(-0.08,0.93,txt,'Units','normalized',...
            'FontSize',14,'FontWeight','normal','FontName', 'Times');
        
        txt = {'0.5'};
        text(-0.08,0.045,txt,'Units','normalized',...
            'FontSize',14,'FontWeight','normal','FontName', 'Times');
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            % Ta = Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a1 = params.gamma_a;
            gamma_s1 = params.gamma_s;
        ...
        case 2
            % Ta = Ts = 5 (4x assortivity)
            infile = 'SEIR_agedep_twodiseases_dbit_Shanghai_T5and6_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [169,90,161]/255; % violet
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
        ...
        case 3
            % Ta = 8, Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_nsvp2_Shanghai_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a3 = params.gamma_a;
            gamma_s3 = params.gamma_s;
        ...
        case 4
            ...
            % Ta = 8, Ts = 5 (4x assortivity)
            infile = 'SEIR_agedep_twodiseases_dbvp_Shanghai_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a4 = params.gamma_a;
            gamma_s4 = params.gamma_s;
    ...
    if counter==4
        ...
        legend_char4 = ['$T_a = ', num2str(1/gamma_a4),'$ with Symptomatic Variation'];
