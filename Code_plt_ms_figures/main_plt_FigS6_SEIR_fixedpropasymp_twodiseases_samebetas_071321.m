...
%% Figure S6 - parametrised with same beta values
...
figure_name = 'FigS6_fixedpropasymp_samebetas_071321';
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 5
            % load: Ta=5 (same)
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_071321_T5and5.mat';
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_071321_T5and6.mat';
            load(strcat('./sim_data/',infile));
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 5
            % load: Ta=5 (same)
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_071321_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_071321_T5and6_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [169,90,161]/255; % violet
            gamma_a2 = params.gamma_a;
