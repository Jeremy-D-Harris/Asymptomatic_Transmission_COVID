...
figure_name = 'FigureS6_correlations_samebetas_fix_120222';
...
for counter=1:length(switch_over_var)
    ...
    switch this_file
        ...
        case 1
            ...
            % load: Ta=5 (Ts=5)
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and5.mat';
        ...
        case 3
            ...
            % load: Ta=5 (same),
            infile = 'SEIR_assortmixing_twodiseases_samebetas_120122_fix_T5and5.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
        ...
        case 4
            % WITH assortative mixing
            % load: Ta=8 (Ta=5)
            infile = 'SEIR_assortmixing_twodiseases_samebetas_120122_fix_T5and8.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
...
for counter=1:length(switch_over_var)
    ...
    switch this_file
       ...
       case 1
            % NO assortative mixing
            % load: Ta=5 (Ts=5)
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_s1 = params.gamma_s;
            gamma_a1 = params.gamma_a;
        ...
        case 3
            % WITH assortative mixing
            % load: Ta=5 (same),
            infile = 'SEIR_assortmixing_twodiseases_samebetas_120122_fix_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_s3 = params.gamma_s;
            gamma_a3 = params.gamma_a;
        ...
        case 4
            % WITH assortative mixing
            % load: Ta=8 (Ta=5)
            infile = 'SEIR_assortmixing_twodiseases_samebetas_120122_fix_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_s4 = params.gamma_s;
            gamma_a4 = params.gamma_a;
