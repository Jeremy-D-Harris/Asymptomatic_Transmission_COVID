...
figure_name = 'Figurelike3_agedep_assortativity_symptomaticity_samebetas_101022_wgray';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_T5and5.mat';
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymp_samebetas_T5and8.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 3
            % Ts = 5, Ta = 8 (assortivity+symptomaticity)
            infile = 'SEIR_agedep_twodiseases_variationsymp_samebetas_T2and8.mat';
            load(strcat('./sim_data/',infile));
    ...
    axis([0 params.t_span(end) 25 50]);
    %     xlabel('Time (days)');
    ...
    if counter==3
        ...
        set(f1,'xticklabel',{[]},'yticklabel',[{''},{'30'},{''},{'40'},{''},{''}]);
        box('off');
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymp_samebetas_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
        ...
        case 3
            % Ta = Ts = 5 (4x assortivity)
            infile = 'SEIR_agedep_twodiseases_variationsymp_samebetas_T2and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [0,0,0]/255; % light blue
            gamma_a3 = params.gamma_a;
            gamma_s3 = params.gamma_s;
