...
figure_name = 'Figure3_agedep_Shanghai_nosuscvar_020822';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5_ia2.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
        ...
        case 4
            ...
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8_ia2.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 2
            % Ta = Ts = 5 (4x assortivity)
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and5_mit_ia2.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
        ...
        case 4
            ...
            % Ta = 8, Ts = 5 (4x assortivity)
            infile = 'SEIR_agedep_twodiseases_nosuscvar_Shanghai_T5and8_mit_ia2.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a4 = params.gamma_a;
            gamma_s4 = params.gamma_s;
