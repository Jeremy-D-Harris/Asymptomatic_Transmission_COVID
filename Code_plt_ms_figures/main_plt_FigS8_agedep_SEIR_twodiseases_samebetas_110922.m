...
figure_name = 'FigureS8_agedep_assortativity_symptomaticity_samebetas_110922';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            % Ta = Ts = 5 (assortivity+symptomaticity)
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_samebetas_110922_T5and5.mat';
            ...
            params.variation_symptomaticity_yesno=0; % to get dashed line
            
            
        case 2
            % Ts = 5, Ta = 8 (assortivity+symptomaticity)
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_samebetas_110922_T5and8.mat';
            load(strcat('./sim_data/',infile));
...
%         case 3
%             % Ts = 5, Ta = 8 (assortivity+symptomaticity)
%             infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_T2and8.mat';
%             load(strcat('./sim_data/',infile));
...
%             params.variation_symptomaticity_yesno=0; % to get dashed line
    ...
    if counter==2
        ...
        set(f1,'xticklabel',{[]},'yticklabel',[{''},{'35'},{'40'},{''}]);
        box('off');
    ...
    axis([0 params.t_span(end) 0.4 0.9]);
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_samebetas_110922_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a1 = params.gamma_a;
            gamma_s1 = params.gamma_s;
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_samebetas_110922_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
...
%         case 3
%             % Ta = Ts = 5 (4x assortivity)
%             infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_T2and8_mit.mat';
%             load(strcat('./sim_data/',infile));
%             cbf_colors = [0,0,0]/255; % light blue
%             gamma_a3 = params.gamma_a;
%             gamma_s3 = params.gamma_s;
...
%             params.variation_symptomaticity_yesno=0; % to get dashed line
    ...
    if params.variation_symptomaticity_yesno==0
        ...
        this_h(counter).Color(4) = 1-0.18*counter;
    else
        this_h(counter)=semilogy(params.t_span, results.i_all_total_fraction,'--','Color',cbf_colors,'LineWidth',2); hold on;
...
%         legend_char3 = ['$T_s = ', num2str(1/gamma_s3),'$, $T_a = ', num2str(1/gamma_a3),'$'];
        ...
        legend(this_h,{legend_char1,legend_char2}, 'Interpreter','Latex','Position',[0.75 0.89 0.1 0.05],'FontSize',10.5);
%         legend(this_h,{legend_char1,legend_char2,legend_char3}, 'Interpreter','Latex','Location','NorthEast','FontSize',10.5);
        legend boxoff
