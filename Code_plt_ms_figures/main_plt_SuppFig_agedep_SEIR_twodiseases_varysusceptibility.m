...
figure_name = 'Figure_agedep_varyTa';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            ...
            infile = 'SEIR_agedep_twodiseases_variationsusceptibility_T5and5.mat';
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsusceptibility_T5and8.mat';
            load(strcat('./sim_data/',infile));
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            % Ta = Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_variationsusceptibility_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a1 = params.gamma_a;
            gamma_s1 = params.gamma_s;
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsusceptibility_T5and8_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [133,192,249]/255; % light blue
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
    ...
    if counter==2
        ...
        legend_char1 = ['$T_s = ', num2str(1/gamma_s1),'$, $T_a = ', num2str(1/gamma_a1),'$, Variation Susceptibility'];
        legend_char2 = ['$T_s = ', num2str(1/gamma_s2),'$, $T_a = ', num2str(1/gamma_a2),'$, Variation Susceptibility'];
