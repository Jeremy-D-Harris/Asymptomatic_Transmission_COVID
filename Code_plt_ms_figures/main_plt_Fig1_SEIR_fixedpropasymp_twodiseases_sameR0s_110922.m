...
figure_name = 'Figure1_fixedpropasymp_sameR0s_110922';
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_sameR0s_110922_T5and6.mat';
            load(strcat('./sim_data/',infile));
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_sameR0s_110922_T5and6_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [169,90,161]/255; % violet
            beta_s2 = params.beta_s;
            beta_a2 = params.beta_a;
