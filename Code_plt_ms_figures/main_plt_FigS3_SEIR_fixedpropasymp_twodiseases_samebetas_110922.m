...
figure_name = 'FigureS3_fixedpropasymp_samebetas_110922';
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and6.mat';
            load(strcat('./sim_data/',infile));
...
for counter=1:length(switch_over_Ta)
    ...
    switch which_Ta
        ...
        case 6
            % load: Ta=6
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_110922_T5and6_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [169,90,161]/255; % violet
            gamma_s2 = params.gamma_s;
            gamma_a2 = params.gamma_a;
