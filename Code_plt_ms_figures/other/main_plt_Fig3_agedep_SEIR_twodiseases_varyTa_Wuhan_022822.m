...
figure_name = 'PotentialFigure3_agedep_assortativity_symptomaticity_varyTa_Wuhan_030722';
...
%         legend(this_h,{legend_char1,legend_char2}, 'Interpreter','Latex','Position',[0.695 0.89 0.1 0.05],'FontSize',10.5);
        legend(this_h,{legend_char1,legend_char2}, 'Interpreter','Latex','Location','NorthEast','FontSize',10.5);
        legend boxoff
