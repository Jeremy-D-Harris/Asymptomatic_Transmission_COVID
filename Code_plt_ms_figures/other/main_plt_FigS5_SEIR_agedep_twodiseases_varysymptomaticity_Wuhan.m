...
figure_name = 'PotentialFigureS5_agedep_assortativity_varysymptomaticity_Wuhan_030722';
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            ...
            infile = 'SEIR_agedep_twodiseases_novariationsymptomaticity_Wuhan_T5and5.mat';
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_Wuhan_T5and5.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
    ...
    axis([0 params.t_span(end) 0.5 1]);
    yticks([0.5 0.75 1]);
    %     xlabel('Time (days)');
    ...
    if counter==2
        ...
        old_pos = get(f1, 'Position');
          ...
          set(f1,'xticklabel',{[]},'yticklabel',[{' '},{'0.75'},{' '}]);
        box('off');
    ...
    axis([0 params.t_span(end) 0.15 4]);
...
for counter=1:length(switch_over_var)
    ...
    switch which_var
        ...
        case 1
            % Ta = Ts = 5 (regular assortivity)
            infile = 'SEIR_agedep_twodiseases_novariationsymptomaticity_Wuhan_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a1 = params.gamma_a;
            gamma_s1 = params.gamma_s;
        ...
        case 2
            ...
            infile = 'SEIR_agedep_twodiseases_variationsymptomaticity_Wuhan_T5and5_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [15,32,128]/255; % dark blue
            gamma_a2 = params.gamma_a;
            gamma_s2 = params.gamma_s;
...
%             params.variation_symptomaticity_yesno=1; % to get dashed line
    ...
    if counter==2
        ...
        legend_char1 = ['$T_s = T_a = ', num2str(1/gamma_a1),'$, Assortativity'];
        legend_char2 = ['$T_s = T_a = ', num2str(1/gamma_a2),'$, Assortativity $+$ Symptomaticity'];
        ...
        legend(this_h,{legend_char1,legend_char2}, 'Interpreter','Latex','Position',[0.7 0.89 0.1 0.05],'FontSize',10.5);
        legend boxoff
    ...
    if counter==2
        ...
        txt = {'1'};
        text(-0.065,0.93,txt,'Units','normalized',...
            'FontSize',14,'FontWeight','normal','FontName', 'Times');
