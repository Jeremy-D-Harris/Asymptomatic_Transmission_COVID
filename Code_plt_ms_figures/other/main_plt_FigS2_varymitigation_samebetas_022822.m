...
figure_name = 'FigureS2_varymitigation_samebetas_022822';
...
for counter=1:3
    ...
    switch counter
        ...
        case 1
            ...
            % load:
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_022822_T5and8_20days_mit.mat';
        ...
        case 2
            % load:
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_022822_T5and8_30days_mit.mat';
            load(strcat('./sim_data/',infile));
        ...
        case 3
            ...
            % load:
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_022822_T5and8_40days_mit.mat';
            load(strcat('./sim_data/',infile));
...
for counter=1:3
    ...
    switch counter
        ...
        case 1
            ...
            % load:
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_022822_T5and8_2xintense_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [0 0 0]; % black
            R_inf(3)=results.Rt_fixedpropasymp(end);
            %             gamma_a3 = params.gamma_a;
        ...
        case 3
            ...
            % load:
            infile = 'SEIR_fixedpropasymp_twodiseases_samebetas_022822_T5and8_halfintense_mit.mat';
            load(strcat('./sim_data/',infile));
            cbf_colors = [0.5 0.5 0.5]; % gray
            R_inf(1)=results.Rt_fixedpropasymp(end);
            %             gamma_a1 = params.gamma_a;
