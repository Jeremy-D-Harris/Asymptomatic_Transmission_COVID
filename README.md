# Individual-level differences in symptomatic and asymptomatic transmission shape population-level dynamics of the SARS-CoV-2 outbreaks
Jeremy Harris and Sang Woo Park and collaborators, January 2022

 -- updated 01/30/22 by jdh --

**Code for:** JD Harris, SW Park, J Dushoff, JS Weitz et al. "Individual-level differences in symptomatic and asymptomatic transmission shape population-level dynamics of the SARS-CoV-2 outbreaks" This repository contains all the Matlab codes for running the three SEIR models of asymptomatic transmission: <br>
...
- **Data** Folder containing data shown and used: <br>
  ...
  - 'Provisional_COVID19_DeathCounts_by_Sex_Age_and_Week.csv' includes CDC provisional end of week death counts from COVID-19 US 2020
